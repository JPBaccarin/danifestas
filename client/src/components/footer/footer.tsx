  ...
  <footer className="bottom-1 w-full bg-primary py-6 text-primary-foreground mt-8">
    <div className="container mx-auto flex flex-wrap justify-center md:justify-between ">
      ...
      <div className="mt-6 flex w-full sm:justify-center md:mt-0 md:w-1/4 lg:w-1/5">
        <div>
          <h4 className="mb-2 scroll-m-20 border-b border-border text-lg font-semibold tracking-tight first:mt-0">
            Links Rápidos
          </h4>
      ...
      <div className="mt-6 flex w-full sm:justify-center md:mt-0 md:w-1/4 lg:w-1/5">
        <div>
          <h4 className="mb-2 scroll-m-20 border-b text-lg font-semibold tracking-tight first:mt-0">
            Siga-nos
          </h4>
          <div className="flex pt-1 text-muted/80">
            <Link
              target="_blank"
              href="https://api.whatsapp.com/send/?phone=5519993794432&text&type=phone_number&app_absent=0"
              className="mr-4 duration-300 hover:text-white"
            >
              <svg
                stroke="currentColor"
                fill="currentColor"
